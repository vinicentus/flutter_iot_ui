...
'''),
            ...
            onChanged: (value) {
              setState(() {
                model.subtractParticleSizes = value;
              });
            },
          ),
          SwitchListTile(
...
Higher values mean smoother lines on the graph.'''),
              ...
              Slider(
                ...
                onChanged: (double value) {
                  setState(() {
                    model.movingAverageSamples = value.toInt();
                  });
                },
              ),
            ],
          ...
          Column(
            children: [
              ...
              Slider(
                ...
                onChanged: (double value) {
                  setState(() {
                    model.graphRefreshTime = Duration(seconds: value.toInt());
                  });
                },
              ),
            ],
